...
-- Tu respuesta aquí
nombre, apellido FROM usuarios_lenguajes WHERE lenguaje = "Java" AND edad < 25;
...
-- Ejercicio 38: Encontrar el lenguaje del usuario creado más tarde. 
                    ...
                    -- NO HAY COLUMNA DE CREACIÓN POR LO QUE INVESTIGUE SERÏA ALGO ASÍ
SELECT lenguaje FROM usuarios_lenguajes WHERE creacion = (SELECT MAX(creacion) FROM usuarios_lenguajes);
